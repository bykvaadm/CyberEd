1. ДЗ находится тут: https://github.com/bykvaadm/secinfo-docker/tree/master/PartII
2. поднять 2 вм из текущего репозитория
3. далее сделать то, что описано в репозитории выше. При работе с тем репозиторием учитывать:
