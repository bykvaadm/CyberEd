...
8. terraform init
9. в файле cyberED/meta.txt укажите ваш ssh ключ в 8й строчке
10. в файле cyberED/variables.tf можно указать иной image_id или зону если это нужно - будет применено на все
    лабораторные
11. terraform apply -> yes # должны создаться объекты. можно их посмотреть в облаке
